...
class Pass1_assembler {
  ...
  public static void main(String args[]) throws Exception{
      int locate=0;
      int litcount = 0;
      BufferedReader reader = new BufferedReader(new FileReader("D:\\java\\eclipse-workplace\\SPOS\\src\\practical\\input.txt")); //FOR INPUT FILE
      BufferedWriter writer= new BufferedWriter(new FileWriter("D:\\java\\eclipse-workplace\\SPOS\\src\\practical\\output.txt")); //FOR OUTPUT FILE
      BufferedWriter writer1= new BufferedWriter(new FileWriter("D:\\java\\eclipse-workplace\\SPOS\\src\\practical\\symtab.txt")); //FOR SYMBOL TABLE FILE
      BufferedWriter writer2= new BufferedWriter(new FileWriter("D:\\java\\eclipse-workplace\\SPOS\\src\\practical\\littab.txt")); //FOR LITERAL TABLE FILE
